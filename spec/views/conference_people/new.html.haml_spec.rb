...
RSpec.describe "conference_people/new", :type => :view do
  before(:each) do
    assign(:conference_person, ConferencePerson.new(
      :conference => nil,
      :person => nil,
  ...
  it "renders new conference_person form" do
    render

    assert_select "form[action=?][method=?]", conference_people_path, "post" do
