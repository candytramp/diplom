...
class ArticleTest < ActiveSupport::TestCase
  ...
  # end
	test "should not save article without name" do
 		article = Article.new
		article.attributes = { start_page: 3, finish_page: 50, year: 2010, source: {name: "World of Science", type: 'magazine',
	...
	test "should not save article without start_page" do
 		article = Article.new
		article.attributes = { name: "Art#1", finish_page: 50, year: 2010, source: {name: "World of Science", type: 'magazine',
                              year: 2000, output: 7, in_rinc: false, is_russian: false}}
 		assert_not article.save, "Impossible to save article without start_page"
	end
    test "should not save article without finish_page" do
 		article = Article.new
		article.attributes = { name: "Art#1", start_page: 3,  year: 2010, source: {name: "World of Science", type: 'magazine',
                              year: 2000, output: 7, in_rinc: false, is_russian: false}}
 		assert_not article.save, "Impossible to save article without finish_page"
	end
	test "should not save article without year" do
 		article = Article.new
		article.attributes = { name: "Art#1", start_page: 3, finish_page: 50, year: 2000, source: {name: "World of Science", type: 'magazine',
   ...
   test "start_page must be integer" do
 		article = Article.new
		article.attributes = { name: "Art#1", start_page: "gff3", finish_page: 50, year: 2010, source: {name: "World of Science", type: 'magazine',
                              year: 2000, output: 7, in_rinc: false, is_russian: false}}
 		assert_not article.save, "StartPage must be numeric"
	end
    test "finish_page must be integer" do
 		article = Article.new
		article.attributes = { name: "Art#1", start_page: 3, finish_page: "thtrhrh50", year: 2010, source: {name: "World of Science", type: 'magazine',
                              year: 2000, output: 7, in_rinc: false, is_russian: false}}
 		assert_not article.save, "StartPage must be numeric"
	end
	 test "year must be integer" do
 		article = Article.new
		article.attributes = { name: "Art#1", start_page: 3, finish_page: 50, source: {name: "World of Science", type: 'magazine',
    ...
    test "type of source must be specified" do
	  ...
	  test "Magazine must have name attribute" do
 		article = Article.new
		article.attributes = { name: "Art#1", start_page: 3, finish_page: 50, source: {type: 'magazine',
                              year: 2000, output: 7, in_rinc: false, is_russian: false}}
    ...
    test "Convert values in_rinc is_russian#1" do
 		article = Article.new
        article.attributes = { name: "Art#1",start_page: 3, finish_page: 50, year: 2010, source: {name: "World of Science", type: 'magazine',
